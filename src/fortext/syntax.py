    ...
    *,
    ...
    for i, (key, val) in enumerate(dictionary.items()):
        ...
        pretty_value = highlight(
            val, indent=indent, curr_indent=indent + curr_indent, pre_indent=False, colors=colors
        )
